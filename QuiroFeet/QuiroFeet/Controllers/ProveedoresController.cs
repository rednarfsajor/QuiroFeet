...
namespace QuiroFeet.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombre,contacto,correo,numero")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,contacto,correo,numero")] Proveedor proveedor)
        {
            if (ModelState.IsValid)
            {
